 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/organization/0.1.72/play_2_5_client
 */
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.37 http://www.apidoc.me/flow/organization/0.1.72/play_2_5_client"
    val Version = "0.1.72"
    val VersionMajor = 0
    ...
    object Invitations extends Invitations {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/invitations", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw new io.flow.organization.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw new io.flow.organization.v0.errors.ValidationErrorResponse(r)
  ...
  package errors {
    ...
    case class ValidationErrorResponse(
      ...
      lazy val validationError = _root_.io.flow.organization.v0.Client.parseJson("io.flow.error.v0.models.ValidationError", response, _.validate[io.flow.error.v0.models.ValidationError])
    }
