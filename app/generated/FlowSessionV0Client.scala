 ...
 * apibuilder:0.12.61 https://app.apibuilder.io/flow/session/0.3.82/play_2_5_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsSessionOrganizationSession: play.api.libs.json.Reads[OrganizationSession] = {
      (
        ...
        (__ \ "experience").readNullable[io.flow.experience.v0.models.ExperienceGeo]
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.61 https://app.apibuilder.io/flow/session/0.3.82/play_2_5_client"
    val Version = "0.3.82"
    val VersionMajor = 0
