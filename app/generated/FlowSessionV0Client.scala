 ...
 * apibuilder:0.12.87 https://app.apibuilder.io/flow/session/0.3.82/play_2_5_client
 */
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.87 https://app.apibuilder.io/flow/session/0.3.82/play_2_5_client"
    val Version = "0.3.82"
    val VersionMajor = 0
