 ...
 * Service version: 0.6.28
 * apibuilder 0.14.75 app.apibuilder.io/flow/checkout-configuration/0.6.28/play_2_x_json
 */
...
package io.flow.checkout.configuration.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCheckoutConfigurationCheckoutSettings: play.api.libs.json.Reads[CheckoutSettings] = {
      (__ \ "session_persistence_timeout").readNullable[io.flow.common.v0.models.Duration].map { x => new CheckoutSettings(sessionPersistenceTimeout = x) }
    }
