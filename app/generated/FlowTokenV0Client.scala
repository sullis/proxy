 ...
 * apidoc:0.11.74 http://www.apidoc.me/flow/token/0.2.50/play_2_5_client
 */
...
package io.flow.token.v0.models {
  ...
  package object json {
    ...
    def jsObjectTokenPartnerReference(obj: io.flow.token.v0.models.TokenPartnerReference) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.74 http://www.apidoc.me/flow/token/0.2.50/play_2_5_client"
    val Version = "0.2.50"
    val VersionMajor = 0
