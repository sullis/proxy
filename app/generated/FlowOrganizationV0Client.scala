 ...
 * apidoc:0.11.29 http://www.apidoc.me/flow/organization/0.0.41/play_2_4_client
 */
package io.flow.organization.v0.models {
  ...
  case class Invitation(
    ...
    role: io.flow.organization.v0.models.Role,
  ...
  case class InvitationForm(
    ...
    role: io.flow.organization.v0.models.Role = io.flow.organization.v0.models.Role.Member
  )
  ...
  /**
   * Represents the status of a membership request
   */
  sealed trait ReviewStatus

  object ReviewStatus {

    case object Pending extends ReviewStatus { override def toString = "pending" }
    case object Approved extends ReviewStatus { override def toString = "approved" }
    case object Declined extends ReviewStatus { override def toString = "declined" }
     ...
     */
    case class UNDEFINED(override val toString: String) extends ReviewStatus
     ...
     * above.
     */
    val all = Seq(Pending, Approved, Declined)

    private[this]
    val byName = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): ReviewStatus = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[ReviewStatus] = byName.get(value.toLowerCase)
...
package io.flow.organization.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsOrganizationReviewStatus = new play.api.libs.json.Reads[io.flow.organization.v0.models.ReviewStatus] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.organization.v0.models.ReviewStatus] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.organization.v0.models.ReviewStatus(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.organization.v0.models.ReviewStatus(v))
    ...
    def jsonWritesOrganizationReviewStatus(obj: io.flow.organization.v0.models.ReviewStatus) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectReviewStatus(obj: io.flow.organization.v0.models.ReviewStatus) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesOrganizationReviewStatus: play.api.libs.json.Writes[ReviewStatus] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.ReviewStatus] {
        def writes(obj: io.flow.organization.v0.models.ReviewStatus) = {
          jsonWritesOrganizationReviewStatus(obj)
        }
      }
    }

    implicit val jsonReadsOrganizationRole = new play.api.libs.json.Reads[io.flow.organization.v0.models.Role] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[io.flow.organization.v0.models.Role] = {
        js match {
          case v: play.api.libs.json.JsString => play.api.libs.json.JsSuccess(io.flow.organization.v0.models.Role(v.value))
          case _ => {
            (js \ "value").validate[String] match {
              case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.organization.v0.models.Role(v))
              case err: play.api.libs.json.JsError => err
            }
          }
        }
    ...
    def jsonWritesOrganizationRole(obj: io.flow.organization.v0.models.Role) = {
      play.api.libs.json.JsString(obj.toString)
    }

    def jsObjectRole(obj: io.flow.organization.v0.models.Role) = {
      play.api.libs.json.Json.obj("value" -> play.api.libs.json.JsString(obj.toString))
    }

    implicit def jsonWritesOrganizationRole: play.api.libs.json.Writes[Role] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.Role] {
        def writes(obj: io.flow.organization.v0.models.Role) = {
          jsonWritesOrganizationRole(obj)
        }
      }
    }
    ...
    implicit def jsonReadsOrganizationInvitation: play.api.libs.json.Reads[Invitation] = {
      (
        ...
        (__ \ "role").read[io.flow.organization.v0.models.Role] and
    ...
    implicit def jsonReadsOrganizationInvitationForm: play.api.libs.json.Reads[InvitationForm] = {
      (
        ...
        (__ \ "role").read[io.flow.organization.v0.models.Role]
    ...
    implicit def jsonReadsOrganizationMembershipPutForm: play.api.libs.json.Reads[MembershipPutForm] = {
      (__ \ "role").read[io.flow.organization.v0.models.Role].map { x => new MembershipPutForm(role = x) }
    }
...
package io.flow.organization.v0 {
  ...
  object Bindables {
    ...
    // Enum: ReviewStatus
    private[this] val enumReviewStatusNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.organization.v0.models.ReviewStatus.all.mkString(", ")}"

    implicit val pathBindableEnumReviewStatus = new PathBindable.Parsing[io.flow.organization.v0.models.ReviewStatus] (
      ReviewStatus.fromString(_).get, _.toString, enumReviewStatusNotFound
    )

    implicit val queryStringBindableEnumReviewStatus = new QueryStringBindable.Parsing[io.flow.organization.v0.models.ReviewStatus](
      ReviewStatus.fromString(_).get, _.toString, enumReviewStatusNotFound
    )

    // Enum: Role
    private[this] val enumRoleNotFound = (key: String, e: _root_.java.lang.Exception) => s"Unrecognized $key, should be one of ${io.flow.organization.v0.models.Role.all.mkString(", ")}"

    implicit val pathBindableEnumRole = new PathBindable.Parsing[io.flow.organization.v0.models.Role] (
      Role.fromString(_).get, _.toString, enumRoleNotFound
    )

    implicit val queryStringBindableEnumRole = new QueryStringBindable.Parsing[io.flow.organization.v0.models.Role](
      Role.fromString(_).get, _.toString, enumRoleNotFound
    )
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.29 http://www.apidoc.me/flow/organization/0.0.41/play_2_4_client"
    val Version = "0.0.41"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Memberships extends Memberships {
      override def get(
        ...
        organization: _root_.scala.Option[String] = None,
        role: _root_.scala.Option[Seq[io.flow.organization.v0.models.Role]] = None,
        limit: Long = 25,
        offset: Long = 0,
        sort: String = "-created_at",
        expand: _root_.scala.Option[Seq[String]] = None,
