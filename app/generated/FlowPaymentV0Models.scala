 ...
 * apibuilder 0.14.75 app.apibuilder.io/flow/payment/0.7.73/play_2_x_json
 */
package io.flow.payment.v0.models {
   ...
   * @param token The token of the credit card with which to create the source.
   * @param last4 Last four digits of the customer's credit card.
   * @param expirationMonth The month of expiration expressed as a number. 1 = January, 12 = December
   * @param expirationYear The 4 digit expiration year
   * @param `type` The brand of credit card, such as VISA or MasterCard.
   * @param billingAddress The billing address for this card.
   */
  final case class CardPaymentSourceForm(
    customerNumber: String,
    token: _root_.scala.Option[String] = None,
    last4: _root_.scala.Option[String] = None,
    expirationMonth: _root_.scala.Option[Int] = None,
    expirationYear: _root_.scala.Option[Int] = None,
    `type`: _root_.scala.Option[io.flow.payment.v0.models.CardType] = None,
    billingAddress: _root_.scala.Option[io.flow.common.v0.models.BillingAddress] = None
  ...
  package object json {
    ...
    implicit def jsonReadsPaymentCardPaymentSourceForm: play.api.libs.json.Reads[CardPaymentSourceForm] = {
      for {
        ...
        token <- (__ \ "token").readNullable[String]
        last4 <- (__ \ "last4").readNullable[String]
        expirationMonth <- (__ \ "expiration_month").readNullable[Int]
        expirationYear <- (__ \ "expiration_year").readNullable[Int]
        `type` <- (__ \ "type").readNullable[io.flow.payment.v0.models.CardType]
        billingAddress <- (__ \ "billing_address").readNullable[io.flow.common.v0.models.BillingAddress]
      } yield CardPaymentSourceForm(customerNumber, token, last4, expirationMonth, expirationYear, `type`, billingAddress)
    }
    ...
    def jsObjectCardPaymentSourceForm(obj: io.flow.payment.v0.models.CardPaymentSourceForm): play.api.libs.json.JsObject = {
      ...
      (obj.last4 match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("last4" -> play.api.libs.json.JsString(x))
      }) ++
      (obj.expirationMonth match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("expiration_month" -> play.api.libs.json.JsNumber(x))
      }) ++
      (obj.expirationYear match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("expiration_year" -> play.api.libs.json.JsNumber(x))
      }) ++
      (obj.`type` match {
        case None => play.api.libs.json.Json.obj()
    ...
    implicit def jsonReadsPaymentCardPaymentSourceSummary: play.api.libs.json.Reads[CardPaymentSourceSummary] = {
      for {
        ...
        `type` <- (__ \ "type").readNullable[io.flow.payment.v0.models.CardType]
        billingAddress <- (__ \ "billing_address").readNullable[io.flow.common.v0.models.BillingAddress]
      } yield CardPaymentSourceSummary(customerNumber, token, last4, expirationMonth, expirationYear, `type`, billingAddress)
    }
    ...
    def jsObjectPaymentSource(obj: io.flow.payment.v0.models.PaymentSource): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.payment.v0.models.CardPaymentSource => jsObjectCardPaymentSource(x) ++ play.api.libs.json.Json.obj("discriminator" -> "card_payment_source")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    def jsObjectPaymentSourceForm(obj: io.flow.payment.v0.models.PaymentSourceForm): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.payment.v0.models.CardPaymentSourceForm => jsObjectCardPaymentSourceForm(x) ++ play.api.libs.json.Json.obj("discriminator" -> "card_payment_source_form")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
