 ...
 * Service version: 0.1.25
 * apidoc:0.11.74 http://www.apidoc.me/flow/session-internal/0.1.25/play_2_5_client
 */
...
package io.flow.session.internal.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsSessionInternalSessionForm: play.api.libs.json.Reads[SessionForm] = {
      (
    ...
    implicit def jsonReadsSessionInternalSessionPutForm: play.api.libs.json.Reads[SessionPutForm] = {
      (
        (__ \ "experience").readNullable[String] and
        (__ \ "country").readNullable[String] and
        (__ \ "currency").readNullable[String] and
...
package io.flow.session.internal.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.74 http://www.apidoc.me/flow/session-internal/0.1.25/play_2_5_client"
    val Version = "0.1.25"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object SessionAuthorizations extends SessionAuthorizations {
      override def post(
        ...
        _executeRequest("POST", s"/authorizations/sessions", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.session.internal.v0.Client.parseJson("io.flow.session.internal.v0.models.SessionAuthorization", r, _.validate[io.flow.session.internal.v0.models.SessionAuthorization])
          ...
          case r => throw new io.flow.session.internal.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401, 422")
        }
      }
    }
    ...
    object Sessions extends Sessions {
      ...
      override def postOrganizationsByOrganization(
        ...
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.session.internal.v0.models.OrganizationSession] = {
        ...
        _executeRequest("POST", s"/sessions/organizations/${play.utils.UriEncoding.encodePathSegment(organization, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.session.internal.v0.Client.parseJson("io.flow.session.internal.v0.models.OrganizationSession", r, _.validate[io.flow.session.internal.v0.models.OrganizationSession])
          case r if r.status == 422 => throw new io.flow.session.internal.v0.errors.GenericErrorResponse(r)
