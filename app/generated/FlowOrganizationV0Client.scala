 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/organization/0.6.73/play_2_6_client
 */
...
package io.flow.organization.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsOrganizationOrganizationForm: play.api.libs.json.Reads[OrganizationForm] = {
      ...
      } yield OrganizationForm(id, name, environment, parentId)
    }
    ...
    implicit def jsonReadsOrganizationOrganizationPutForm: play.api.libs.json.Reads[OrganizationPutForm] = {
      for {
        ...
        parentId <- (__ \ "parent_id").readNullable[String]
      } yield OrganizationPutForm(name, environment, parentId)
    }
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/organization/0.6.73/play_2_6_client"
    val Version = "0.6.73"
    val VersionMajor = 0
