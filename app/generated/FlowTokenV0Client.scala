 ...
 * apidoc:0.11.49 http://www.apidoc.me/flow/token/0.2.4/play_2_5_client
 */
package io.flow.token.v0.models {
  ...
  case class PartnerToken(
    id: String,
    partner: io.flow.token.v0.models.PartnerReference,
    user: io.flow.common.v0.models.UserReference,
    environment: io.flow.common.v0.models.Environment,
    partial: String,
    createdAt: _root_.org.joda.time.DateTime,
...
package io.flow.token.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsTokenPartnerReference: play.api.libs.json.Reads[PartnerReference] = {
      (__ \ "id").read[String].map { x => new PartnerReference(id = x) }
    }

    def jsObjectPartnerReference(obj: io.flow.token.v0.models.PartnerReference) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesTokenPartnerReference: play.api.libs.json.Writes[PartnerReference] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.PartnerReference] {
        def writes(obj: io.flow.token.v0.models.PartnerReference) = {
    ...
    implicit def jsonReadsTokenPartnerToken: play.api.libs.json.Reads[PartnerToken] = {
      (
        (__ \ "id").read[String] and
        (__ \ "partner").read[io.flow.token.v0.models.PartnerReference] and
        (__ \ "user").read[io.flow.common.v0.models.UserReference] and
        (__ \ "environment").read[io.flow.common.v0.models.Environment] and
        (__ \ "partial").read[String] and
        (__ \ "created_at").read[_root_.org.joda.time.DateTime] and
    ...
    def jsObjectPartnerToken(obj: io.flow.token.v0.models.PartnerToken) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "partner" -> jsObjectPartnerReference(obj.partner),
        "user" -> io.flow.common.v0.models.json.jsObjectUserReference(obj.user),
        "environment" -> play.api.libs.json.JsString(obj.environment.toString),
        "partial" -> play.api.libs.json.JsString(obj.partial),
        "created_at" -> play.api.libs.json.JsString(_root_.org.joda.time.format.ISODateTimeFormat.dateTime.print(obj.createdAt))
    ...
    implicit def jsonReadsTokenTokenReference: play.api.libs.json.Reads[TokenReference] = new play.api.libs.json.Reads[TokenReference] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[TokenReference] = {
        (js \ "discriminator").validate[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case "legacy_token_reference" => js.validate[io.flow.token.v0.models.LegacyTokenReference]
    ...
    def jsObjectTokenReference(obj: io.flow.token.v0.models.TokenReference) = {
      obj match {
        case x: io.flow.token.v0.models.LegacyTokenReference => jsObjectLegacyTokenReference(x) ++ play.api.libs.json.Json.obj("discriminator" -> "legacy_token_reference")
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.49 http://www.apidoc.me/flow/token/0.2.4/play_2_5_client"
    val Version = "0.2.4"
    val VersionMajor = 0
