 ...
 * Service version: 0.2.14
 * apidoc:0.11.74 http://www.apidoc.me/flow/organization/0.2.14/play_2_5_client
 */
package io.flow.organization.v0.models {
  ...
  sealed trait InvitationErrorCode
...
package io.flow.organization.v0.models {
  ...
  package object json {
    ...
    def jsObjectInvitationError(obj: io.flow.organization.v0.models.InvitationError) = {
      play.api.libs.json.Json.obj(
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.74 http://www.apidoc.me/flow/organization/0.2.14/play_2_5_client"
    val Version = "0.2.14"
    val VersionMajor = 0
