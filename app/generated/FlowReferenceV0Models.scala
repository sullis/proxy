 ...
 * apibuilder:0.12.61 https://app.apibuilder.io/flow/reference/0.4.4-add-currencies-to-payment-methods/play_2_x_json
 */
  ...
  package object json {
    ...
    implicit def jsonReadsReferencePaymentMethod: play.api.libs.json.Reads[PaymentMethod] = {
      (
        ...
        (__ \ "regions").read[Seq[String]] and
        (__ \ "supported_currencies").readNullable[Seq[io.flow.reference.v0.models.Currency]]
    ...
    def jsObjectPaymentMethod(obj: io.flow.reference.v0.models.PaymentMethod): play.api.libs.json.JsObject = {
      ...
      ) ++ (obj.supportedCurrencies match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("supported_currencies" -> play.api.libs.json.Json.toJson(x))
      })
    }
